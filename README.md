...
plugins, libraries, locales, and Owl metadata are reused directly. A required Linux Quit-confirmation compatibility patch changes
`resources/app.asar` in the default build. The official ELF runtime and bundled
